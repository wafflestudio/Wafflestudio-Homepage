...
set :repository,  "git@github.com:waffle-studio/Wafflestudio-Homepage.git"

set :scm, :git
set :branch, "master"
set :ssh_options, { :forward_agent => true }
set :deploy_to, "/var/www/wafflestudio_homepage"
set :assets_prefix, 'assets'
set :asset_env, "RAILS_GROUPS=assets"

role :web, "wafflestudio.com"

set :user, 'wafflehomepage'
...
namespace :deploy do
  ...
  task :symlink, :roles => :web, :except => { :no_release => true } do
    ...
    sudo "chown -R wafflehomepage:wafflehomepage #{shared_path}/.."
